...
export const I18N = {
  tr: {
    ...
    cardRightBody: "Yukarı aşağı hareket ses seviyesini belirler. 1-4 parmak akor stilini seçer: üçlü, çevrim, 7'li, 9'lu. Eli yatırmak tonu değiştirir, başparmak aşağı bakarsa bir oktav düşer. Elini hızlıca sallarsan aynı akor tekrar çalar.",
    cardCamTitle: "Kamera",
  ...
  en: {
    ...
    cardRightBody: "Move up and down to control volume. 1-4 fingers pick the chord style: triad, inversion, 7th, 9th. Tilting changes the tone; thumb pointing down drops an octave. Give your hand a quick shake to strum the chord again.",
    cardCamTitle: "Camera",
  ...
  es: {
    ...
    cardRightBody: "Mueve la mano arriba y abajo para el volumen. 1-4 dedos eligen el estilo del acorde: tríada, inversión, 7ª, 9ª. Inclinar cambia el tono; el pulgar hacia abajo baja una octava. Agita la mano rápido para volver a rasguear el acorde.",
    cardCamTitle: "Cámara",
  ...
  pt: {
    ...
    cardRightBody: "Mova para cima e para baixo para o volume. 1-4 dedos escolhem o estilo do acorde: tríade, inversão, 7ª, 9ª. Inclinar muda o timbre; polegar para baixo desce uma oitava. Balance a mão rapidamente para tocar o acorde de novo.",
    cardCamTitle: "Câmera",
  ...
  de: {
    ...
    cardRightBody: "Auf und ab bewegen regelt die Lautstärke. 1-4 Finger wählen den Akkordstil: Dreiklang, Umkehrung, Septime, None. Neigen ändert den Klang; Daumen nach unten senkt eine Oktave. Schüttle die Hand kurz, um den Akkord erneut anzuschlagen.",
    cardCamTitle: "Kamera",
  ...
  fr: {
    ...
    cardRightBody: "Montez et descendez la main pour le volume. 1 à 4 doigts choisissent le style d'accord : triade, renversement, 7e, 9e. Incliner change le timbre ; pouce vers le bas descend d'une octave. Secouez la main pour rejouer l'accord.",
    cardCamTitle: "Caméra",
  ...
  ru: {
    ...
    cardRightBody: "Двигайте руку вверх-вниз для громкости. 1-4 пальца выбирают стиль аккорда: трезвучие, обращение, септима, нона. Наклон меняет тембр; большой палец вниз — октавой ниже. Быстро встряхните руку, чтобы сыграть аккорд ещё раз.",
    cardCamTitle: "Камера",
  ...
  ja: {
    ...
    cardRightBody: "手を上下に動かして音量を調整。1〜4本の指でコードスタイルを選択:トライアド、転回形、7th、9th。手を傾けると音色が変化、親指を下に向けると1オクターブ下がります。手を素早く振ると同じコードをもう一度鳴らせます。",
    cardCamTitle: "カメラ",
  ...
  ko: {
    ...
    cardRightBody: "손을 위아래로 움직여 음량을 조절. 1-4개의 손가락으로 코드 스타일 선택: 3화음, 자리바꿈, 7th, 9th. 손을 기울이면 톤이 바뀌고, 엄지를 아래로 향하면 한 옥타브 내려갑니다. 손을 빠르게 흔들면 같은 코드를 다시 연주합니다.",
    cardCamTitle: "카메라",
